  ...
  const handleReceiptPrint = () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .receipt-customer-row { display: flex; flex-direction: row-reverse; justify-content: space-between; border-top: 1px solid #888; padding: 2mm 0; font-size: 11pt; font-weight: 700; }
      ...
      .receipt-field { display: flex; flex-direction: row-reverse; justify-content: space-between; font-size: 10pt; margin-bottom: 1mm; }
      .receipt-field-label { font-weight: 700; }
      .receipt-page-footer { display: flex; flex-direction: row-reverse; justify-content: space-between; align-items: flex-end; margin-top: 4mm; border-top: 1px solid #ddd; padding-top: 2mm; font-size: 7pt; color: #666; }
      .receipt-disclaimer { max-width: 50%; text-align: right; }
      ...
      .receipt-page-customer .receipt-customer-row { flex-direction: row-reverse; justify-content: center; gap: 10mm; font-size: 14pt; }
