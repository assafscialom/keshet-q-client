...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if ($cutTypeDataType) {
            $dataRow = $this->dataRow($cutTypeDataType, 'id');
            if (!$dataRow->exists) {
                $dataRow->fill([
                    'type'         => 'number',
                    'display_name' => __('voyager::seeders.data_rows.id'),
            ...
            $dataRow = $this->dataRow($cutTypeDataType, 'name');
            if (!$dataRow->exists) {
                $dataRow->fill([
                    'type'         => 'text',
                    'display_name' => 'שם',
            ...
            $dataRow = $this->dataRow($cutTypeDataType, 'created_at');
            if (!$dataRow->exists) {
                $dataRow->fill([
                    'type'         => 'timestamp',
                    'display_name' => __('voyager::seeders.data_rows.created_at'),
            ...
            $dataRow = $this->dataRow($cutTypeDataType, 'updated_at');
            if (!$dataRow->exists) {
                $dataRow->fill([
                    'type'         => 'timestamp',
                    'display_name' => __('voyager::seeders.data_rows.updated_at'),
            ...
            $dataRow = $this->dataRow($cutTypeDataType, 'deleted_at');
            if (!$dataRow->exists) {
                $dataRow->fill([
                    'type'         => 'timestamp',
